...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView{
    int currentPostion = scrollView.contentOffset.x/[UIScreen mainScreen].bounds.size.width;
    NSLog(@"13= %d",currentPostion);
    NSUserDefaults * user = [NSUserDefaults standardUserDefaults];
    [user setObject:[NSString stringWithFormat:@"%d",currentPostion] forKey:@"sum"];
...
- (void)pageContentView:(LZPageContentView *)pageContentView didClickBtnIndex:(NSInteger)index
{
    ...
    //[user setObject:[NSString stringWithFormat:@"%ld",index] forKey:@"sum"];
